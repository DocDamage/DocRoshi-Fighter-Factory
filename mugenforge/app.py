...
class MugenForgeApp(FeatureBankActions, CreatorOSActions, CreatorSuiteActions, FactoryMaxActions, FactoryUltraActions, ImageFactoryActions, QualityLabActions, tk.Tk):
    def __init__(self):
        super().__init__()
