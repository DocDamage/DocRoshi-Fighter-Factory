...
class MugenForgeApp(FeatureBankActions, CreatorOSActions, CreatorSuiteActions, FactoryMaxActions, FactoryPlusActions, FactoryUltraActions, ImageFactoryActions, QualityLabActions, VisualForgeActions, tk.Tk):
    def __init__(self):
        super().__init__()
