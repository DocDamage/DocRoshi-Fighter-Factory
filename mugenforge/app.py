...
from .ff_plus_tools import (
    full_project_report, export_move_list, write_creator_manual, sound_cue_sheet,
)
...
class MugenForgeApp(FeatureBankActions, CreatorOSActions, CreatorSuiteActions, AssetWorkspaceActions, FactoryMaxActions, FactoryPlusActions, FactoryUltraActions, ImageFactoryActions, QualityLabActions, VisualForgeActions, tk.Tk):
    def __init__(self):
        super().__init__()
