...
class MugenForgeApp(FeatureBankActions, CreatorOSActions, CreatorSuiteActions, AirEditorActions, AssetWorkspaceActions, CodeAuthoringActions, FactoryMaxActions, FactoryPlusActions, FactoryUltraActions, ImageFactoryActions, PaletteActions, PlusWorkspaceActions, ProjectCoreActions, QualityLabActions, SoundPipelineActions, SpritePipelineActions, VisualForgeActions, tk.Tk):
    def __init__(self):
        super().__init__()
