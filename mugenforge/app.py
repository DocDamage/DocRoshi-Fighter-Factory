...
class MugenForgeApp(FeatureBankActions, CreatorOSActions, CreatorSuiteActions, AssetWorkspaceActions, FactoryMaxActions, FactoryPlusActions, FactoryUltraActions, ImageFactoryActions, PaletteActions, PlusWorkspaceActions, QualityLabActions, SoundPipelineActions, SpritePipelineActions, VisualForgeActions, tk.Tk):
    def __init__(self):
        super().__init__()
