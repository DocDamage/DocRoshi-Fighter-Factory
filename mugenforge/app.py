...
class MugenForgeApp(FeatureBankActions, CreatorOSActions, CreatorSuiteActions, AssetWorkspaceActions, FactoryMaxActions, FactoryPlusActions, FactoryUltraActions, ImageFactoryActions, PlusWorkspaceActions, QualityLabActions, VisualForgeActions, tk.Tk):
    def __init__(self):
        super().__init__()
